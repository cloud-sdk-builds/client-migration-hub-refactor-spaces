...
[`@aws-sdk/client-migration-hub-refactor-spaces`](https://www.npmjs.com/package/@aws-sdk/client-migration-hub-refactor-spaces/v/3.1119.0).
...
- @aws-sdk/client-migration-hub-refactor-spaces v3.1119.0 - [https://cloud-sdk-builds.github.io/?sdk=client-migration-hub-refactor-spaces&version=3.1119.0](https://cloud-sdk-builds.github.io/?sdk=client-migration-hub-refactor-spaces&version=3.1119.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migration-hub-refactor-spaces@3.1119.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jff6w3CTe9VsFpZOovvUNrxZjdqwiSHAS9wvgl/lePiDvNXqqj8dEPDtkzeRtP+y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-migration-hub-refactor-spaces": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migration-hub-refactor-spaces@3.1119.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migration-hub-refactor-spaces@3.1119.0/index.min.mjs": "sha384-jff6w3CTe9VsFpZOovvUNrxZjdqwiSHAS9wvgl/lePiDvNXqqj8dEPDtkzeRtP+y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-migration-hub-refactor-spaces/blob/refs/tags/3.1119.0/LICENSE
```
