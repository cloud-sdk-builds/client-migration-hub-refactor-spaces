...
[`@aws-sdk/client-migration-hub-refactor-spaces`](https://www.npmjs.com/package/@aws-sdk/client-migration-hub-refactor-spaces/v/3.72.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migration-hub-refactor-spaces@3.72.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2G8XkSySBjxXtjeVXg1pg5ntSGAqE4OgLApOgg1TtA3cKggy1ShTpH76pm6zmqR1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-migration-hub-refactor-spaces": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migration-hub-refactor-spaces@3.72.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migration-hub-refactor-spaces@3.72.0/index.min.mjs": "sha384-2G8XkSySBjxXtjeVXg1pg5ntSGAqE4OgLApOgg1TtA3cKggy1ShTpH76pm6zmqR1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-migration-hub-refactor-spaces/blob/refs/tags/3.72.0/LICENSE
```
